...
TextWrap.prototype._construct = function () {
	...
	// this was originally "line-interval" but most browsers can't get invalid
	// properties, so I changed it to "line-height" (which makes sense anyways).
	this.setLineInterval( style.getPropertyValue('line-height') );
...
TextWrap.prototype.getOuterXML = function (node) {
	var serializer = new XMLSerializer();
	var text = serializer.serializeToString(node);
	return text;
}

TextWrap.prototype.getCurrentStyle = function (node) {
